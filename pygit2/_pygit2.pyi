...
class _ObjectBase(Generic[_T]):
    ...
    raw_name: bytes | None
    short_id: str
    type: 'Literal[ObjectType.COMMIT] | Literal[ObjectType.TREE] | Literal[ObjectType.TAG] | Literal[ObjectType.BLOB]'
...
class Reference:
    ...
    @overload
    def peel(self, type: 'Literal[ObjectType.COMMIT] | Type[Commit]') -> 'Commit': ...
    @overload
...
class Tree(Object):
    ...
    def __contains__(self, other: str | bytes, /) -> bool: ...  # Tree_contains
    def __getitem__(
        self, index: str | bytes | int, /
    ) -> Tree | Blob: ...  # Tree_subscript
    def __iter__(self) -> Iterator[Object]: ...
    def __len__(self) -> int: ...  # Tree_len
    def __rtruediv__(self, other: str | bytes, /) -> Tree | Blob: ...
    def __truediv__(self, other: str | bytes, /) -> Tree | Blob: ...  # Tree_divide

@disjoint_base
class TreeBuilder:
    def clear(self) -> None: ...
    def get(self, name: str | bytes, /) -> Object: ...
    def insert(self, name: str | bytes, oid: _OidArg, attr: int) -> None: ...
