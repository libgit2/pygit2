...
int git_submodule_save(git_submodule *subm);
int git_submodule_sync(git_submodule *subm);
int git_submodule_reload(git_submodule *subm, int force);
...
int git_submodule_set_url(git_submodule *subm, const char *url);
