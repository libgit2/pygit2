...
#   sh build.sh
#
# Build libgit2 1.4.1 (will use libssh2 if available), then build pygit2
# inplace:
#
#   LIBGIT2_VERSION=1.4.1 sh build.sh
#
# Build libssh2 1.10.0 and libgit2 1.4.1, then build pygit2 inplace:
#
#   LIBSSH2_VERSION=1.10.0 LIBGIT2_VERSION=1.4.1 sh build.sh
#
# Tell where libssh2 is installed, build libgit2 1.4.1, then build pygit2
# inplace:
#
#   LIBSSH2_PREFIX=/usr/local LIBGIT2_VERSION=1.4.1 sh build.sh
#
