...
.. code-block:: sh
   ...
   $ wget https://github.com/libgit2/libgit2/archive/refs/tags/v1.4.0.tar.gz -O libgit2-1.4.0.tar.gz
...
.. code-block:: sh
   ...
   $ git clone --depth=1 -b v1.4.0 https://github.com/libgit2/libgit2.git
   $ cd libgit2
