...
.. code-block:: sh
   ...
   wget https://github.com/libgit2/libgit2/archive/refs/tags/v1.9.7.tar.gz -O libgit2-1.9.7.tar.gz
   tar -xzf libgit2-1.9.7.tar.gz
   cd libgit2-1.9.7/
   cmake .
   make
   sudo make install
...
.. code-block:: pwsh
   ...
   git clone --depth=1 -b v1.9.7 https://github.com/libgit2/libgit2.git
